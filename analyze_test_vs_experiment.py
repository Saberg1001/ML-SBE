...
"""Compare test and experimental predictions in one consolidated report."""
...
TEST_PREDICTIONS = (
    ...
    / "models"
    / "current"
    / "ionic_main_35_features_all_models_50"
    / "lightgbm"
...
EXPERIMENT_PREDICTIONS = (
    ...
    / "predictions"
    / "main"
    / "experimental-data_35_with_family"
    / "predictions.csv"
)
...
def read_experiment_predictions() -> pd.DataFrame:
    ...
    columns = ["ID", "True Composition", "true_log10", "pred_log10"]
